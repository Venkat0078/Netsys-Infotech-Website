        ...
        <div className="font-sans text-[#666666] bg-white selection:bg-[#086AD8] selection:text-white">
            ...
            <div className="hidden lg:flex justify-between items-center py-2 px-8 bg-[#032240] text-gray-300 text-sm">
                <div className="flex gap-6">
                    ...
                    <span className="flex items-center gap-2 hover:text-white cursor-pointer"><MapPin size={14} className="text-[#086AD8]" /> T. Nagar, Chennai, Tamil Nadu 600017</span>
                </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden lg:flex items-center gap-3">
                            <div className="text-right hidden xl:block">
                                ...
                                <span className="block text-[#032240] font-bold">+91 9940276633</span>
                            </div>
